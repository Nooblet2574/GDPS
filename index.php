...
<body style="background: linear-gradient(#6D00FC, #330074);">
    <center>
        ...
        <div>
            ...
            <br>
            <!-- Upper buttons -->
            <a href="<?php echo $windows; ?>Windows.zip"download><img src="files/windows.png" width="200" hspace="12"></a>
            <a href="<?php echo $android; ?>Android.apk"download><img src="files/android.png" width="200" hspace="12"></a>
            <?php $tools = "tools/index.php"; ?><a href="<?php echo $tools; ?>"><img src="files/tools.png" width="200" hspace="12"></a>
            <!-- Add buttons below -->
        </div>
